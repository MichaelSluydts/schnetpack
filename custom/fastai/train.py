...
from schnetpack2.custom.fastai.callbacks import *
from schnetpack2.custom.fastai.basic_data import *
from schnetpack2.custom.fastai.basic_train import *
...
def fit_one_cycle(learn:Learner, cyc_len:int, max_lr:Union[Floats,slice]=defaults.lr,
                  ...
                  wd:float=None, callbacks:Optional[CallbackList]=None, tot_epochs:int=None, start_epoch:int=None, no_grad_val:Optional[bool]=True)->None:
    ...
    learn.fit(cyc_len, max_lr, wd=wd, callbacks=callbacks, no_grad_val=no_grad_val)

def lr_find(learn:Learner, start_lr:Floats=1e-7, end_lr:Floats=10, num_it:int=100, stop_div:bool=True, wd:float=None, no_grad_val:Optional[bool]=True):
    ...
    learn.fit(epochs, start_lr, callbacks=[cb], wd=wd, no_grad_val=no_grad_val)
