...
class AtomsData(Dataset):
    ...
    Args:
        ...
        environment_provider (schnetpack2.environment.EnvironmentProvider): method to collect atom neighbors
    ...
    def create_subset(self, idx):
        ...
        Returns:
            schnetpack2.data.AtomsData: dataset with subset of original data
        """
        idx = np.array(idx)
    ...
    def create_splits(self, num_train=None, num_val=None, split_file=None):
        ...
        Returns:
            schnetpack2.data.AtomsData: training dataset
            schnetpack2.data.AtomsData: validation dataset
            schnetpack2.data.AtomsData: test dataset
