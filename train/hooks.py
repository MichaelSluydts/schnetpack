...
__all__ = [
    ...
    'LRScheduleHook', 'ReduceLROnPlateauHook', 'ExponentialDecayHook', 'WarmRestartHook', 'SaveAllGrads', 'SetBreakPoint'
]
...
class SetBreakPoint(Hook):
    def __init__(self):
      self.all_grads_dict = {}
  
    def on_batch_begin(self, trainer, train_batch):
  #    pdb.set_trace()
      for name, module in trainer._model.named_modules():
          module.register_backward_hook(self.break_point(name))
  
    def break_point(self, name):
